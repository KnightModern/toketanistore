...
import com.toketanistore.app.Config.SharedPref;
...
public class My_Today_Order_Adapter extends RecyclerView.Adapter<My_Today_Order_Adapter.MyViewHolder> implements Filterable {
    ...
    private List<TodayOrderModel> searchList;
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<TodayOrderModel> filteredList = new ArrayList<>();
                    for (TodayOrderModel row : searchList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                modelList = (ArrayList<TodayOrderModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }

    public void setDataAfterSearch(List<TodayOrderModel> todayOrderModels) {
