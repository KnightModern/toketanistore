...
import com.toketanistore.app.Model.NewAllProductModel;
import com.toketanistore.app.R;
import com.toketanistore.app.util.AllProductClickListner;
    ...
    return new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charString.isEmpty()) {
                productListFiltered = searchList;
            } else {
                List<NewAllProductModel> filteredList = new ArrayList<>();
                for (NewAllProductModel row : searchList) {
                    if (row.getProduct_name().toLowerCase().contains(charString.toLowerCase()) || row.getProduct_id().contains(charSequence)) {
